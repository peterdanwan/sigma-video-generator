...
# Set up lighting (optional, as the material is not affected by lighting in this setup)
bpy.ops.object.light_add(type='SUN', radius=1, location=(0, 0, 10))

# Set the output path
output_path = os.path.join(os.path.dirname(bpy.data.filepath), "output", "test_output.mp4")
